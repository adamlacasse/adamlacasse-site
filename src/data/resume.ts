  ...
  experience: [
    {
      ...
      achievements: [
        ...
        'Defined shared data contracts and migration patterns (dual-write, shadow read, expand-contract) across [N] downstream consumers - new services can stand up behind the live monolith without disrupting reporting pipelines or customer-facing data flows.',
        'Established service boundaries, rollout sequencing, and reference patterns the broader program builds against - [concrete in-flight outcome: e.g., N pilot services in active development against the new contracts, M architecture decisions ratified across the program].',
        `<strong>People & Talent platforms (2021-2025):</strong> Lead engineer on three platforms that consolidated a sprawl of third-party tools and spreadsheets - Goals & Growth (performance), Concierge (people knowledge hub), and Merit (recognition) - supporting Liberty's "best place to work" strategic priority across ~40K multilingual employees.`,
        ...
        '<strong>Operating principles across both platforms:</strong> boring tools, explicit boundaries, small reversible shipments - applied through engineer mentorship and design/review standards adjacent teams now follow.',
